...
# qweight = make_tensor(K//8, N, dtype=torch.int32)
# c = make_tensor(M,N, dtype=torch.float16)
# qzeros = make_tensor(G, N//8, torch.int32)
# scales = make_tensor(G, N, torch.float16)
# # debug = torch.empty_like(a)
# triton_out = triton_matmul4(groupsize, a, qweight, scales, qzeros)
# print(f"triton_output={triton_out}")
# # matmul4_kernel(a, qweight, c, debug, scales, qzeros, groupsize)
